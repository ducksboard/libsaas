...
class ApplicationHosts(ApplicationRelatedResource):
    ...
    def get(self, hostname=None, ids=None, page=None):
        """
        List of hosts associated with the given application.
...
class ApplicationHost(ApplicationRelatedResource):
    ...
    def get(self):
        """
        Fetch a single application host.
        """
        url = '{0}.json'.format(self.get_url())
